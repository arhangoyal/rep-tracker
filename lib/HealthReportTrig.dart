...
class HealthReportTrig extends StatefulWidget {
  @override
...
class LineChartWidget extends State<HealthReportTrig> {
  ...
  AxisTitles getTopTitles() {
    ...
    return AxisTitles(
      ...
      axisNameWidget: Text("Plot of Triglycerides Vs Date", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 13, backgroundColor: Colors.blue.shade600)),
  ...
  AxisTitles getLeftTitles() {
    print("in lefttiles");
    return AxisTitles(
      axisNameWidget: Text ("Triglycerides", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 12, backgroundColor: Colors.blue.shade600)),
      sideTitles: SideTitles(
        interval: 3,
        showTitles: true,
        reservedSize: 40,
        getTitlesWidget: (value, meta) {
          ...
          {
            if ((intVal == myList[i].trig) | (intVal == 0)) {
