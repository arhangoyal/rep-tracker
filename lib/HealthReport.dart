...
class LineChartWidget extends State<HealthReport> {
  intl.DateFormat ymdFormat = intl.DateFormat('yMd');
  ...
  AxisTitles getTopTitles() {
    ...
    return AxisTitles(
      ...
      axisNameWidget: Text("Plot of Weight (Kg) Vs Date", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 13, backgroundColor: Colors.blue.shade600)),
  ...
  AxisTitles getLeftTitles() {
    print("in lefttiles");
    return AxisTitles(
      axisNameWidget: Text ("Weight (Kg)", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 12, backgroundColor: Colors.blue.shade600)),
      sideTitles: SideTitles(
        ...
        getTitlesWidget: (value, meta) {
          ...
          {
            if ((intVal == myList[i].weight) | (intVal == 0)) {
    ...
    return AxisTitles(
      ...
      sideTitles: SideTitles(
        ...
        getTitlesWidget: (value, meta) {
          ...
          //text = ymdFormat.format(DateTime.fromMillisecondsSinceEpoch((value*1000*60).toInt()));
          print(text);
