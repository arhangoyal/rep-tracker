...
class HealthReportLDL extends StatefulWidget {
  @override
...
class LineChartWidget extends State<HealthReportLDL> {
  ...
  AxisTitles getTopTitles() {
    ...
    return AxisTitles(
      ...
      axisNameWidget: Text("Plot of LDL Vs Date", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 13, backgroundColor: Colors.blue.shade600)),
  ...
  AxisTitles getLeftTitles() {
    print("in lefttiles");
    return AxisTitles(
      axisNameWidget: Text ("LDL", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 12, backgroundColor: Colors.blue.shade600)),
      sideTitles: SideTitles(
        interval: 3,
        showTitles: true,
        reservedSize: 20,
        getTitlesWidget: (value, meta) {
          ...
          {
            if ((intVal == myList[i].ldl) | (intVal == 0)) {
